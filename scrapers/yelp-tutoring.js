...
const CATEGORY = 'Tutoring & Learning Centers';
const LOCATIONS = [
  { city: 'Plano', query: 'find_desc=tutoring+center&find_loc=Plano%2C+TX' },
  { city: 'Frisco', query: 'find_desc=tutoring+center&find_loc=Frisco%2C+TX' }
];
const MAX_PAGES = 3;
