...
const CATEGORY = 'Family-Friendly Restaurants';
const LOCATIONS = [
  { city: 'Plano', query: 'find_desc=family+friendly+restaurant+kids&find_loc=Plano%2C+TX' },
  { city: 'Frisco', query: 'find_desc=family+friendly+restaurant+kids&find_loc=Frisco%2C+TX' }
];
const MAX_PAGES = 3;
