...
const CATEGORY = 'Birthday Party Venues';
const LOCATIONS = [
  { city: 'Plano', query: 'find_desc=birthday+party+venue+kids&find_loc=Plano%2C+TX' },
  { city: 'Frisco', query: 'find_desc=birthday+party+venue+kids&find_loc=Frisco%2C+TX' }
];
const MAX_PAGES = 3;
