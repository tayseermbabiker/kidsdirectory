...
const CATEGORY = 'Daycares & Preschools';
const LOCATIONS = [
  { city: 'Plano', query: 'find_desc=daycare+preschool&find_loc=Plano%2C+TX' },
  { city: 'Frisco', query: 'find_desc=daycare+preschool&find_loc=Frisco%2C+TX' }
];
const MAX_PAGES = 3;
