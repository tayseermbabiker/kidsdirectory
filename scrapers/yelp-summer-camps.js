...
const CATEGORY = 'Summer Camps & After School';
const LOCATIONS = [
  { city: 'Plano', query: 'find_desc=summer+camp+after+school&find_loc=Plano%2C+TX' },
  { city: 'Frisco', query: 'find_desc=summer+camp+after+school&find_loc=Frisco%2C+TX' }
];
const MAX_PAGES = 3;
