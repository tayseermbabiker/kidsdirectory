...
const CATEGORY = 'Pediatric Dentists & Doctors';
const LOCATIONS = [
  { city: 'Plano', query: 'find_desc=pediatric+dentist+doctor&find_loc=Plano%2C+TX' },
  { city: 'Frisco', query: 'find_desc=pediatric+dentist+doctor&find_loc=Frisco%2C+TX' }
];
const MAX_PAGES = 3;
