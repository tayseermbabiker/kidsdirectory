...
${businesses.map(b => `  <url>
  ...
  // NOTE: /go/{id} pages are full business profile pages (hours, reviews,
  // "what to expect", comparisons) — real indexable content, NOT redirects.
  // They are kept in the sitemap and indexable on purpose.
